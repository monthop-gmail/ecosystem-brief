...
ขอบเขตที่ห้ามข้าม — เป็นตัวกันไม่ให้ ecosystem กลายเป็นก้อนเดียว
...
> ⚠️ B1–B5 เป็นข้อเสนอตั้งต้นจากการออกแบบ **ยังไม่ผ่าน review ของทีมเจ้าของ repo**
> เมื่อยืนยันแล้วให้ย้ายรายละเอียดไป `docs/contracts.md` และเหลือแค่สรุปที่นี่
